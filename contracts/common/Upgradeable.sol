...
contract Upgradeable is Ownable, ReentrancyGuard {
   ...
   string public UriToken;
   uint256 public IDToken;
    address public token721;
    uint256 public PriceERC20;
    uint256 public PriceNT;
    address public BuyNFTHandler;
    ...
    event SwapEvent(address indexed wallet, uint256 tokenAmount);
    event SetBNBRate(uint256 _rate);
